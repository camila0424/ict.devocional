 ...
 * Coinciden con el frame 0 de `SplashScreen.tsx` (fondo `#1800AD` + halo,
 * sin logo todavía visible) para que el paso a la animación sea sin cortes.
 *
 * Los PNG se generan con `scripts/gen-splash-assets.js` y viven en
 * `public/splash/ios/`.
 */
